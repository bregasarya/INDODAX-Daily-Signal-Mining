...
$crash1="select level, COUNT(level) total, DATE(tanggal) as tgl from btc where level='$level' AND jenis='$jenis' AND tanggal BETWEEN  '$dari_tgl' AND '$sampai_tgl' GROUP BY tgl ";
...
$sql_tanggal="select DATE(tanggal) as tgl from btc where tanggal BETWEEN  '$dari_tgl' AND '$sampai_tgl' Group by tgl";
